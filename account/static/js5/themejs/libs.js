    ...
    (a.jGrowl = function (b, c) {
        ...
        (a.fn.jGrowl = function (b, c) {
            if ((void 0 === c && a.isPlainObject(b) && ((c = b), (b = c.message)), a.isFunction(this.each))) {
                var d = arguments;
                return this.each(function () {
                    void 0 === a(this).data("jGrowl.instance") && (a(this).data("jGrowl.instance", a.extend(new a.fn.jGrowl(), { notifications: [], element: null, interval: null })), a(this).data("jGrowl.instance").startup(this)),
        ...
        a.extend(a.fn.jGrowl.prototype, {
            ...
            create: function (b, c) {
                ...
                "undefined" != typeof d.speed && ((d.openDuration = d.speed), (d.closeDuration = d.speed)), this.notifications.push({ message: b, options: d }), d.log.apply(this.element, [this.element, b, d]);
            },
            render: function (b) {
                var c = this,
                    d = b.message,
                ...
                var f = a("<div/>")
                    .addClass("jGrowl-notification alert " + e.themeState + " ui-corner-all" + (void 0 !== e.group && "" !== e.group ? " " + e.group : ""))
                ...
                a(f)
                    ...
                    .bind("jGrowl.open", function () {
                        e.open.apply(f, [f, d, e, c.element]) !== !1 &&
                            ("after" == e.glue ? a(".jGrowl-notification:last", c.element).after(f) : a(".jGrowl-notification:first", c.element).before(f),
                ...
                a(this.element)
                    ...
                    .each(function () {
                        void 0 !== a(this).data("jGrowl") &&
                            ...
                            (void 0 === a(this).data("jGrowl.pause") || a(this).data("jGrowl.pause") !== !0) &&
